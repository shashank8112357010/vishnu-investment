...
const AdminEditprofile = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/* Profile Section */}
      <div className="w-full mx-auto border bg-gray-900 text-white  rounded-lg shadow-lg py-5  profile-section fade-in">
      ...
      {/* Edit Profile Form */}
      {isEditingProfile && (
        <div className="w-full mx-auto border bg-gray-900 text-white  rounded-lg shadow-lg p-5 mt-5 personal-details-section fade-in">
...
{/* Bank Details Section */}
      <div className="w-full mx-auto border rounded-lg shadow-lg p-5 bg-gray-900 text-white  mt-5 bank-details-section fade-in">
      ...
      <div className="w-full mx-auto border rounded-lg shadow-lg p-5 mt-5 bg-gray-900 text-white  binance-details-section fade-in">
        <h2 className="text-2xl font-bold mb-5 text-center">
      ...
      {isEditingBinance && (
        <div className="w-full mx-auto border rounded-lg shadow-lg p-5 bg-gray-900 text-white  mt-5 binance-details-section fade-in">
          <h2 className="text-2xl font-bold mb-5 text-center">
